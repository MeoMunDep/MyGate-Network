...
- Fill the data for `datas.txt` file, get data from [here](https://t.me/KeoAirDropFreeNe/257/46702). This file contains user data in the following format:
...
- **Help me with your referral** [Referral Link](https://app.mygate.network/login?code=XaBhea)
